...
# --- Theme Checks omitted for brevity in terminal output, but still functional ---

# --- List of config paths (relative to $HOME) to export ---------------------
CONFIG_FILES=(
    # Expanded Shell configs
    .bashrc
    .zshrc
    .bash_profile
    .zprofile
    ...
    # Konsole & Yakuake Settings (Expanded)
    .config/konsolerc
    .config/konsoleui.rc
    .config/sessionui.rc
    .config/yakuakerc
...
# dconf block left unmodified as per previous version...
DCONF_PATHS=(
